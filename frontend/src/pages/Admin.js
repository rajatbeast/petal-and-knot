          ...
          <div className="admin-section">
            ...
            <div className="stats-grid">
              ...
              <div className="stat-card highlight">
                <span className="stat-num">{stats.newOrders}</span>
              ...
              <div className="overview-col">
                ...
                {/* {products.slice(0, 5).map((p) => (
                  <div key={p._id} className="overview-item">
                    ...
                    <span
                      className={`status-badge ${p.inStock ? "status-confirmed" : "status-cancelled"}`}
                    >
              ...
              <table className="admin-table">
                ...
                <tbody>
                  {products.map((p) => (
                    <tr key={p._id}>
                      {/* <td>
                        <span className="t-emoji">{p.emoji}</span> {p.name}
                      </td> */}
                      ...
                      <td>
                        <div className="admin-product-name">
                          <div className="admin-thumb">
                            {p.image ? (
                              <img
                                src={`https://images.weserv.nl/?url=${encodeURIComponent(p.image)}`}
                                alt={p.name}
                                onError={(e) => {
                                  e.target.style.display = "none";
                ...
                <tbody>
                  {orders.map((o) => (
                    <tr key={o._id}>
                      ...
                      <td>{o.phone}</td>
                      <td>
                        <span className="cat-tag">{o.category}</span>
                      </td>
